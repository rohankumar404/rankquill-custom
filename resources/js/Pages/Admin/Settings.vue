...
const tabs = [
    ...
    },
    {
        id: "theme",
        name: "Design & Colors",
        icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-3M9.707 9.707a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L8.414 12l1.293-1.293z",
    },
    {
        id: "seo",
        name: "Default SEO",
    ...
    },
    {
        ...
        icon: "M3 19v-8.93a2 2 0 01.89-1.664l8-5.333a2 2 0 012.22 0l8 5.333A2 2 0 0121 10.07V19M3 19a2 2 0 002 2h14a2 2 0 002-2M3 19l6.75-4.5M21 19l-6.75-4.5m0 0l-2.25-1.5a2 2 0 00-2.22 0l-2.25 1.5m4.5 0v3m-2.25-3v3m4.5-3v3",
    },
    {
        id: "leads",
        name: "Lead Settings",
...
const form = useForm({
    general: {
        ...
        maintenance_mode:
            props.settings.general?.maintenance_mode === "true" ||
            props.settings.general?.maintenance_mode === "1" ||
            props.settings.general?.maintenance_mode === true,
    ...
    seo: {
        ...
        default_seo_description:
            props.settings.seo?.default_seo_description || "",
        default_seo_keywords: props.settings.seo?.default_seo_keywords || "",
        default_seo_robots:
            props.settings.seo?.default_seo_robots || "index, follow",
    },
    smtp: {
    ...
    social_links: props.social_links
        ? props.social_links.map((l) => ({
              ...l,
              is_active: l.is_active === 1 || l.is_active === true,
          }))
        : [],
    leads: {
        lead_notification_emails:
            props.settings.leads?.lead_notification_emails ||
            "hello@rankquill.com,leads@rankquill.com",
        recaptcha_enabled:
            props.settings.leads?.recaptcha_enabled === "true" ||
            props.settings.leads?.recaptcha_enabled === "1" ||
            props.settings.leads?.recaptcha_enabled === true,
    ...
    newsletter: {
        mailchimp_enabled:
            props.settings.newsletter?.mailchimp_enabled === "true" ||
            props.settings.newsletter?.mailchimp_enabled === "1" ||
            props.settings.newsletter?.mailchimp_enabled === true,
        mailchimp_api_key: props.settings.newsletter?.mailchimp_api_key || "",
        mailchimp_list_id: props.settings.newsletter?.mailchimp_list_id || "",
        brevo_enabled:
            props.settings.newsletter?.brevo_enabled === "true" ||
            props.settings.newsletter?.brevo_enabled === "1" ||
            props.settings.newsletter?.brevo_enabled === true,
        brevo_api_key: props.settings.newsletter?.brevo_api_key || "",
        brevo_list_id: props.settings.newsletter?.brevo_list_id || "",
    },
});
...
const submit = () => {
    ...
    form.leads.recaptcha_enabled = form.leads.recaptcha_enabled
        ? "true"
        : "false";
...
const testSmtpConnection = async () => {
    if (!testEmail.value) {
        testResult.value = {
            success: false,
            message: "Please specify a target email address for verification.",
        };
        return;
    }
    ...
    try {
        ...
        const msg =
            ...
            "Verification connection failed. Please double-check SMTP values.";
    ...
    <AdminLayout>
        <div class="mb-8">
            ...
            <p class="text-slate-400 text-sm mt-1">
                Configure global application assets, brand identity, tracking
                scripts, and server parameters.
            </p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-72 flex-shrink-0">
                <div
                    class="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 sticky top-24 space-y-1"
                >
                    <button
                        v-for="tab in tabs"
                        :key="tab.id"
            ...
            <!-- Form Workspace -->
            <div
                class="flex-1 bg-slate-950/70 border border-slate-800 rounded-2xl p-6 md:p-8"
            >
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div v-show="activeTab === 'general'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">
                                Control agency name, tagline, and maintenance
                                state.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                />
                                <span
                                    v-if="form.errors['general.site_name']"
                            ...
                            <div>
                                ...
                                />
                                <span
                                    v-if="form.errors['general.site_tagline']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{
                                        form.errors["general.site_tagline"]
                                    }}</span
                                >
                            </div>
                        </div>
                        ...
                        >
                            <label
                                class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-4"
                                >Agency Brand Logo</label
                            >
                            ...
                            >
                                <!-- Preview box -->
                                <div
                                    class="w-32 h-32 rounded-2xl bg-slate-950 border border-slate-800 flex items-center justify-center overflow-hidden p-3 flex-shrink-0"
                                >
                                    <img
                                        v-if="logoPreview"
                                        :src="logoPreview"
                                ...
                                <div class="space-y-3 w-full">
                                    ...
                                    <p class="text-xs text-slate-500">
                                        Supports PNG, JPG, or SVG. Maximum file
                                        size 2MB.
                                    </p>
                                </div>
                            </div>
                        ...
                        <!-- Maintenance Mode -->
                        <div
                            class="flex items-center justify-between p-5 bg-slate-900/50 border border-slate-800 rounded-2xl"
                        >
                            <div>
                                <h4
                                ...
                                <p class="text-xs text-slate-500 mt-1">
                                    Direct public visitors to a maintenance
                    ...
                    <div v-show="activeTab === 'contact'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">
                                Define support credentials and geographical
                                locations.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <span
                                v-if="form.errors['contact.contact_email']"
                                class="text-xs text-rose-500 mt-1 block"
                                >{{
                                    form.errors["contact.contact_email"]
                                }}</span
                            >
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <span
                                v-if="form.errors['contact.contact_phone']"
                                class="text-xs text-rose-500 mt-1 block"
                                >{{
                                    form.errors["contact.contact_phone"]
                                }}</span
                            >
                        </div>
                        ...
                        <div>
                            <label
                                for="contact_address"
                                class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                >Physical Headquarters Address</label
                            >
                            <textarea
                            ...
                            ></textarea>
                            <span
                                v-if="form.errors['contact.contact_address']"
                                class="text-xs text-rose-500 mt-1 block"
                                >{{
                                    form.errors["contact.contact_address"]
                                }}</span
                            >
                        </div>
                    </div>
                    ...
                    <div v-show="activeTab === 'theme'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">
                                Control agency font families and key hex color
                                templates.
                            </p>
                        </div>
                        ...
                        <!-- Fonts Configuration -->
                        <div
                            class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-900"
                        >
                            <div>
                                <label
                                    for="font_primary"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Primary Typography (Headings)</label
                                >
                                <select
                            ...
                            <div>
                                <label
                                    for="font_secondary"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Secondary Typography (Paragraphs)</label
                                >
                                <select
                    ...
                    <div v-show="activeTab === 'seo'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">
                                Control agency standard meta tags if individual
                                page variables are absent.
                            </p>
                        </div>

                        <div>
                            <label
                                for="default_seo_title"
                                class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                            ...
                            />
                            <span
                                v-if="form.errors['seo.default_seo_title']"
                                class="text-xs text-rose-500 mt-1 block"
                                >{{
                                    form.errors["seo.default_seo_title"]
                                }}</span
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <span
                                v-if="
                                    form.errors['seo.default_seo_description']
                                "
                                class="text-xs text-rose-500 mt-1 block"
                                >{{
                                    form.errors["seo.default_seo_description"]
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                                    for="default_seo_keywords"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Default SEO Keywords</label
                                >
                                <input
                            ...
                            <div>
                                <label
                                    for="default_seo_robots"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Search Crawler Policy (Robots)</label
                                >
                                <select
                                ...
                                >
                                    ...
                                    <option value="noindex, nofollow">
                                        noindex, nofollow (Private settings)
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div v-show="activeTab === 'scripts'" class="space-y-6">
                        <div
                            class="border-b border-slate-800 pb-4 mb-6 flex items-center justify-between"
                        >
                            <div>
                                <h3 class="text-lg font-bold text-slate-100">
                                ...
                                <p class="text-xs text-slate-500 mt-0.5">
                                    Embed Google Analytics, pixel codes, and
                                    analytics scripts safely.
                                </p>
                            </div>
                            <button
                                type="button"
                        ...
                        <div
                            ...
                            class="text-center py-10 bg-slate-900/30 border border-dashed border-slate-800 rounded-2xl"
                        >
                            <svg
                                class="h-10 w-10 text-slate-650 mx-auto mb-3"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                                stroke-width="1.5"
                            ...
                            <p class="text-sm font-medium text-slate-500">
                                No custom script blocks registered.
                            </p>
                        </div>
                        ...
                        <div v-else class="space-y-6">
                            ...
                            >
                                ...
                                <div
                                    class="grid grid-cols-1 md:grid-cols-2 gap-4 mr-8"
                                >
                                    <div>
                                        <label
                                            class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                        >Code Snippet (HTML/Javascript)</label
                                    >
                                    <textarea
                                        v-model="script.code"
                                        rows="4"
                                ...
                                <div
                                    class="flex items-center space-x-6 pt-2 border-t border-slate-950"
                                >
                                    <label
                                        class="inline-flex items-center space-x-2.5 cursor-pointer"
                                    >
                                        <input
                                            type="checkbox"
                    ...
                    <div v-show="activeTab === 'socials'" class="space-y-6">
                        ...
                        >
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mt-0.5">
                                    Manage references to agency accounts on
                                    social platforms.
                                </p>
                            </div>
                            <button
                        ...
                        >
                            ...
                            <p class="text-sm font-medium text-slate-500">
                                No social platforms linked yet.
                            </p>
                        </div>
                        ...
                        <div v-else class="space-y-4">
                            ...
                            >
                                ...
                                <div
                                    class="grid grid-cols-1 sm:grid-cols-12 gap-4 flex-1 w-full mr-6 md:mr-0"
                                >
                                    <div class="sm:col-span-3">
                                        <label
                                            class="block text-[10px] font-semibold uppercase tracking-wider text-slate-500 mb-1"
                                            >Platform Name</label
                                        >
                                        <input
                                    ...
                                    <div
                                        class="sm:col-span-2 flex items-center pt-5 sm:pt-6"
                                    >
                                        <label
                    ...
                    <div v-show="activeTab === 'smtp'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">
                                Configure transaction SMTP relay details for
                                site alerts and inquiries.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-2">
                                <label
                                    for="smtp_host"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Mail Host (Server Address)</label
                                >
                                <input
                                ...
                                />
                                <span
                                    v-if="form.errors['smtp.host']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{ form.errors["smtp.host"] }}</span
                                >
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <span
                                    v-if="form.errors['smtp.port']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{ form.errors["smtp.port"] }}</span
                                >
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label
                                    for="smtp_username"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Server Account ID (Username)</label
                                >
                                <input
                                ...
                                />
                                <span
                                    v-if="form.errors['smtp.username']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{ form.errors["smtp.username"] }}</span
                                >
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <span
                                    v-if="form.errors['smtp.password']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{ form.errors["smtp.password"] }}</span
                                >
                            </div>
                            ...
                            <div>
                                ...
                                <span
                                    v-if="form.errors['smtp.encryption']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{ form.errors["smtp.encryption"] }}</span
                                >
                            </div>
                        </div>
                        ...
                        >
                            <div>
                                ...
                                />
                                <span
                                    v-if="form.errors['smtp.from_address']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{
                                        form.errors["smtp.from_address"]
                                    }}</span
                                >
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <span
                                    v-if="form.errors['smtp.from_name']"
                                    class="text-xs text-rose-500 mt-1 block"
                                    >{{ form.errors["smtp.from_name"] }}</span
                                >
                            </div>
                        </div>
                        ...
                        >
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mt-1">
                                    Route transactional application
                                    notifications via this configuration.
                                </p>
                            </div>
                            <button
                                type="button"
                                @click="
                                    form.smtp.is_active = !form.smtp.is_active
                                "
                                :class="[
                                    form.smtp.is_active
                                        ? 'bg-indigo-600'
                        ...
                        <div
                            class="bg-indigo-600/5 border border-indigo-500/20 rounded-2xl p-6 space-y-4"
                        >
                            <div>
                                <h4 class="text-sm font-bold text-indigo-400">
                                    SMTP Relay Verification Test
                                </h4>
                                <p class="text-xs text-slate-500 mt-0.5">
                                    Send a quick test message using in-memory
                            ...
                            >
                                <svg
                                    ...
                                    class="h-4.5 w-4.5 text-emerald-500 flex-shrink-0 mt-0.5"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    stroke-width="2"
                                ...
                                <svg
                                    v-else
                                    class="h-4.5 w-4.5 text-rose-500 flex-shrink-0 mt-0.5"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    stroke-width="2"
                    ...
                    <div v-show="activeTab === 'leads'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            <h3 class="text-lg font-bold text-slate-100">
                                Leads & Notification Routing
                            </h3>
                            <p class="text-xs text-slate-500 mt-0.5">
                                Control notification emails, honeypots, and
                        ...
                        <div
                            class="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-4"
                        >
                            <div>
                                <label
                                    for="lead_notification_emails"
                                    class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                    >Notification Alert Emails (Comma
                                    Separated)</label
                                >
                                <input
                                    v-model="
                                        form.leads.lead_notification_emails
                                    "
                                    type="text"
                                ...
                                <p class="text-[10px] text-slate-500 mt-1">
                                    Inquiry details will be relayed to all valid
                                    email addresses defined in this list.
                                </p>
                                <span
                                    v-if="
                                        form.errors[
                        ...
                        <div
                            class="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-6"
                        >
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mt-0.5">
                                    Protect lead submission endpoints against
                                    automated spam scripts.
                                </p>
                            </div>

                            <div
                                class="flex items-center justify-between p-4 bg-slate-950 border border-slate-850 rounded-xl"
                            >
                                <div>
                                    <span
                                        class="text-xs font-semibold text-slate-350 block"
                                        >Enable reCAPTCHA v2</span
                                    >
                                    <span class="text-[10px] text-slate-500"
                                        >Requires recaptcha field verification
                                        on frontend forms if active.</span
                                    >
                                </div>
                                <button
                                    type="button"
                                    @click="
                                        form.leads.recaptcha_enabled =
                                            !form.leads.recaptcha_enabled
                                    "
                                    :class="[
                                        form.leads.recaptcha_enabled
                            ...
                            <div
                                v-if="form.leads.recaptcha_enabled"
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        v-model="
                                            form.leads.recaptcha_secret_key
                                        "
                                        type="password"
                    ...
                    <div v-show="activeTab === 'newsletter'" class="space-y-6">
                        <div class="border-b border-slate-800 pb-4 mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">
                                Sync subscribers automatically with Mailchimp &
                                Brevo API channels.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                <div>
                                    ...
                                    <p class="text-[10px] text-slate-500">
                                        Enable automated contact pushing to your
                                        Mailchimp list.
                                    </p>
                                </div>
                                <button
                                    type="button"
                                    @click="
                                        form.newsletter.mailchimp_enabled =
                                            !form.newsletter.mailchimp_enabled
                                    "
                                    :class="[
                                        form.newsletter.mailchimp_enabled
                            ...
                            <div
                                v-if="form.newsletter.mailchimp_enabled"
                                class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2"
                            >
                                <div>
                                    <label
                                        for="mailchimp_api_key"
                                        class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                        >Mailchimp API Key</label
                                    >
                                    <input
                                        v-model="
                                            form.newsletter.mailchimp_api_key
                                        "
                                        type="password"
                                ...
                                <div>
                                    <label
                                        for="mailchimp_list_id"
                                        class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                        >Mailchimp List (Audience) ID</label
                                    >
                                    <input
                                        v-model="
                                            form.newsletter.mailchimp_list_id
                                        "
                                        type="text"
                        ...
                        >
                            ...
                            >
                                <div>
                                    <h4
                                        class="text-sm font-bold text-slate-200"
                                    >
                                        Brevo (Sendinblue) Synchronization
                                    </h4>
                                    <p class="text-[10px] text-slate-500">
                                        Enable automated contact pushing to your
                                        Brevo lists.
                            ...
                            <div
                                v-if="form.newsletter.brevo_enabled"
                                class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2"
                            >
                                <div>
                                    <label
                                        for="brevo_api_key"
                                        class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2"
                                        >Brevo API Key (v3)</label
                                    >
                                    <input
                                        v-model="form.newsletter.brevo_api_key"
                                        type="password"
                                        id="brevo_api_key"
                                        placeholder="xkeysib-..."
                                        class="w-full px-4 py-3 bg-slate-900 border border-slate-800 rounded-xl focus:outline-none focus:border-indigo-500 text-slate-100 text-xs transition-colors"
                                ...
                                <div>
                                    ...
                                    >
                                    <input
                                        v-model="form.newsletter.brevo_list_id"
                                        type="text"
                                        id="brevo_list_id"
                                        placeholder="e.g. 2"
                                        class="w-full px-4 py-3 bg-slate-900 border border-slate-800 rounded-xl focus:outline-none focus:border-indigo-500 text-slate-100 text-xs transition-colors"
